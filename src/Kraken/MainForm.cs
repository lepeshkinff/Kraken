...
namespace Kraken
{
    public partial class MainForm : Form
    {
        ...
        private async Task ApplyInternal(Func<string, FileConfiguration[], string, Action<decimal>, Task> applyAction)
        {
            ...
            try
            {
                ...
                await applyAction(selectedPathTb.Text, matchingCofigurtions, environment, null);
